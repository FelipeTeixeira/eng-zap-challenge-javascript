...
This repository contains the code of the course [Angular Universal In Depth](https://angular-university.io/course/olx-br).

This course repository is updated to Angular v12.

![Angular Universal In Depth](https://angular-university.s3-us-west-1.amazonaws.com/course-images/olx-br.jpg)
...
We can install the master branch using the following commands:
    ...
    git clone https://github.com/angular-university/olx-br.git
...
If you are looking for the [Angular Universal Course](https://angular-university.io/course/olx-br), the repo with the full code can be found here:
